...
def plot_path(path, robot_path):
	...
	# area1.xaxis.set_major_locator(ml)
	# area1.xaxis.set_minor_locator(Al)
	...
	# area2.xaxis.set_major_locator(ml)
	# area2.xaxis.set_minor_locator(Al)
	...
	# area3.xaxis.set_major_locator(ml)
	# area3.xaxis.set_minor_locator(Al)
