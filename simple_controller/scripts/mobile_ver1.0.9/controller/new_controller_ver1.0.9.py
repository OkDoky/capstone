...
def speed_publisher(pid_dist, pid_theta, inc_x, inc_y):
	...
	if ((err_theta_d > 3 and err_theta_d < 360) or (err_theta_d < -3 and err_theta_d > -360)):
		...
		# print('go')
		if(err_theta_d<0):
			speed.angular.z = -pid_theta*0.01
		else:
			speed.angular.z = pid_theta*0.01
	pub.publish(speed)
